...
export default function TopSection() {
  ...
  return (
    <section className="desktop:h-[70%] flex flex-col desktop:flex-row">
      <div className="overflow-hidden max-h-[30%] desktop:max-h-full desktop:h-full w-full desktop:w-[calc(70%-10rem)]">
        <ImageCarousel sections={sections} currentSection={currentSection} />
      </div>
      <div className="relative w-full desktop:w-[calc(30%+10rem)]">
